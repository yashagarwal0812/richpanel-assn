    ...
    <div className="dashboard-container">
      ...
      <div className="conversations-pane">
        <div className="heading">
            <h2>Conversations</h2>
            <svg className="refresh" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={fetchConversations}>
